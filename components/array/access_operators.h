...
int test_access_operators()
{
    ...
    array2.lin();
    array2.print();
    std::cout << "array2[1][2]: " << array2({1, 2}) << std::endl
              << std::endl;

    Array<float> array3({2, 4, 5});
    array3.lin();
    array3.print();
    std::cout << "array3[1][2][3]: " << array3({1, 2, 3}) << std::endl
              << std::endl;

    Array<float> array4({2, 4, 5, 6});
    array4.lin();
    array4.print();
    std::cout << "array4[1][2][3][4]: " << array4({1, 2, 3, 4}) << std::endl
              << std::endl;

    std::cout << "array1[1] = 10: " << std::endl
              << std::endl;
    array1({1}) = 10;
    array1.print();

    std::cout << "array2[1][2] = 10: " << std::endl
              << std::endl;
    array2({1, 2}) = 10;
    array2.print();
